...
dav.Client.prototype = {
    ...
    propFind : function(url, properties, depth, headers) {
        ...
        // [VWORKSPACE] Fix PUT is denine by Admin
        headers['Target-Request-Method'] ='PROPFIND';
        ...
        return this.request('POST', url, headers, body).then(
            function(result) {
    ...
    propPatch : function(url, properties, headers) {
        ...
        headers['Content-Type'] = 'application/xml; charset=utf-8';
        // [VWORKSPACE] Fix PUT is denine by Admin
        headers['Target-Request-Method'] ='PROPPATCH';
